...
export default function JoinPage() {
  ...
  return (
    <ProtectedRoute>
      <div className="max-w-xl mx-auto py-16 cinematic-stagger">
        <div className="ui-panel text-center p-8">
          ...
          <h1 className="ui-page-title">Unirse a un grupo</h1>
          <p className="text-base-400 mt-2 mb-6">Usa el botón &ldquo;Unirse con código&rdquo; desde el dashboard</p>
